...
// cache
if(file_exists('Guild_status.cch')){
	echo file_get_contents('Guild_status.cch') .'<br><span style="float:right">Update: ' .date('d.m.Y H:i', filemtime('Guild_status.cch')) .'</span>';
} else {
